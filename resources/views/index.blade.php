            ...
            <div class="container">
                <div class="cs_hero_text text-center">
                    ...
                    <p class="cs_hero_subtitle wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.25s">
                        ...
                        powerful features
                        and <br>user-friendly interface, enhance customer experiences, and boost your overall
                        efficiency.
                    </p>
                </div>
...
"><img
                    src="assets/img/Polygon.svg" alt="Polygon Icon"></div>
            <div class="cs_hero_shape2"
                style="left: 55%; top: 45%;  animation: animo-x 9s cubic-bezier(0.4, 0, 0.2, 1) infinite;
"><img
                    src="assets/img/Polygon.svg" alt="Polygon Icon"></div>
                ...
                <div class="row align-items-center cs_gap_y_40">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="cs_pr_45 text-center">
                            <img src="assets/img/illustration.png" alt="Image">
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center cs_gap_y_40 cs_reverse_lg">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="cs_feature_thumb_1 text-center"><img src="assets/img/illustration1.png"
                                alt="Image"></div>
                    </div>
                </div>
            </div>
        ...
        <section id="pricing" class="cs_section_shape_wrap_1 cs_gradient_bg_2 position-relative overflow-hidden">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        ...
                        <form action="https://api.web3forms.com/submit" method="POST" id="cs_form"
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="phone" class="cs_form_field" placeholder="Mobile*"
                                    required>
                                <div class="cs_height_30 cs_height_lg_30"></div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-lg-12">
                                <textarea name="message" rows="7" class="cs_form_field m-0" placeholder="Write Project Details*" required></textarea>
                                <div class="cs_height_30 cs_height_lg_30"></div>
                            </div>
                            <div class="col-lg-12">
                                <button aria-label="Submit button" class="cs_btn cs_bg_accent cs_dark_hover"
                                    type="submit">Send
                                    Message</button>
            ...
            <div class="cs_modal_container cs_white_bg">
                ...
                <div class="cs_post_details cs_style_1">
                    ...
                    <p>Bring to the table win-win survival strategies to ensure proactive domination. At the end of the
                        day,
                        goingforward, a new normal that has evolved from generation X is on the runway heading towards a
                        streamlined
                    ...
                    <div class="cs_post_text">
                        ...
                        <p>Proactively envisioned multimedia based expertise and cross-media growth strategies.
                            ...
                            quality intellectual capital without superior collaboration and idea-sharing. Holistically
                            pontificate
