    ...
    <footer class="cs_site_footer cs_color_1 cs_sticky_footer">
        ...
        <div class="cs_main_footer">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-xl-4">
                        <div class="cs_footer_widget">
                            <div class="cs_text_field">
                                ...
                                <p class="cs_text_white mb-0">
                                    ...
                                    operations into a
                                    streamlined and efficient powerhouse. With a focus on simplicity, versatility, and
                                    cutting-edge
                                    technology.
                                </p>
                            </div>
                        ...
                        <div class="cs_footer_widget">
                            <div class="cs_social_btn cs_style_1 d-flex" style="justify-content: center;">
            ...
            <div class="container cs_copyright_text copyright-container cs_text_white text-center">
                <div>
                    &copy; Copyright 2025. Powered by<a href="https://themeforest.net/user/awesomethemez/portfolio"
                        target="_blank" class="cs_site_link cs_text_accent"> CODE X ENTERPRISE</a>
                </div>
                <div class="tnc-policy" style="gap: 20px;">
